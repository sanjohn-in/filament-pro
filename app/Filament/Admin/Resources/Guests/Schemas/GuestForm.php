            ...
            ->components([
                Section::make(__('messages.guest_information'))
                    ->schema([
                        ...
                        Grid::make(\App\Models\Admin\TableGroup::where('main_category_id', session('main_category_id'))->exists() ? 2 : 3)->schema([
                        ...
                        ])->columnSpan(\App\Models\Admin\TableGroup::where('main_category_id', session('main_category_id'))->exists() ? 1 : 2),
